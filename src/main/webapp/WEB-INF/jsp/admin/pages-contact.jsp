  ...
  <main id="main" class="main">
    ...
    <section class="section contact">
        ...
        <div class="col-xl-12 col-md-12 col-12">
          <div class="card p-4">
            <form:form action="/addContentsave" modelAttribute="contentform" method="post" >
              <div class="row gy-4">
                ...
                <label>Blog url</label>
                  <input type="text" class="form-control" name="blogUrl" id="blogUrl" placeholder="blogUrl" onblur="buildUrl()" required>
                </div>

                <div class="col-md-12">
                <label>Content Data</label>
                  <textarea class="form-control" name="contentdata" rows="6" placeholder="contentdata" required></textarea>
                </div>
                <div>
                <label>Status</label>
