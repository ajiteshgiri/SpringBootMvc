...
<link rel="canonical" href="https://www.usairling.com/es/articulos/${data.titleUrl}">
<link rel="alternate" href="https://www.usairling.com/es/articulos/${data.titleUrl}">
            ...
            <div class="blog-inner-box2">
		        ...
		        <ul class="side_accordion">
		            <div class="heading">Recent links</div>
		              <c:forEach var="data" items="${blogDatas}" begin="0" end="10">
			          <li class="card d-flex py-3 px-3 flex-row ">
			          	<span><i class="fa fa-arrow-right" aria-hidden="true"></i></span>
			            <a href="/es/articulos/${data.titleUrl}"> ${data.heading}</a>
			          </li>
		        </c:forEach>
            </ul>
        </div> 
